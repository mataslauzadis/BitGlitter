...
class EncodeFrame:
    ...
    def begin_session_process(
        ...
        self.ascii_compressed = ascii_header_process(
            self.file_mask_enabled,
            self.active_path,
            self.stream_palette,
            self.bg_version,
            self.stream_name,
        ...
        self.total_frames = how_many_frames(
            self.block_height,
            self.block_width,
            len(self.ascii_compressed),
            self.size_in_bytes,
            self.stream_palette,
            self.header_palette,
            self.output_mode,
        ...
        (
            self.remainder_blocks,
            self.image_output_path,
            self.frame_number_formatted,
        ) = render_loop(
            self.block_height,
            self.block_width,
            self.pixel_width,
            self.PROTOCOL_VERSION,
            self.initializer_palette,
            self.header_palette,
            self.stream_palette,
            self.output_mode,
            ...
            self.file_mask_enabled,
            self.date_created,
            self.ascii_compressed,
            self.stream_sha,
            self.initializer_palette_dict,
            self.header_palette_dict,
